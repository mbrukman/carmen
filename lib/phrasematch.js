...
module.exports = function phrasematch(source, query, options, callback) {
    ...
    while (l--) {
        ...
        if (text) {
            ...
            console.log(' ');
            console.log('~~~phrasematching...~~~');
            console.log('dawg: ');
            console.log(Array.from(dawg));
            // console.log('source: ' + JSON.stringify(source));
            console.log('source._dictcache: ' + JSON.stringify(source._dictcache));
            console.log('phrase text: ' + text);
            console.log('dawg has phrase? ' + dawg.hasPhrase(text, subquery.ender));
        ...
        console.log('phrasematches: ' , phrasematches);
    }
